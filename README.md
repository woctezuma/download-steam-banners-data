...
-   original horizontal images (616x353 resolution, natively larger) in [`original_horizontal_steam_banners.tar`](https://drive.google.com/open?id=1-0FrkH3X1Eji6bDbGNYRTo9_C4PIfqlb),
-   original vertical images (300x450 resolution, available for 42% of games [after the Steam libary update in 2019](https://store.steampowered.com/libraryupdate)) in [`original_vertical_steam_banners.tar`](https://drive.google.com/open?id=1KZ4_eiB4TTZqIwTJOQYzgDvbVXXhEqOe),
